...
\begin{center}
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \draw[very thick] (2) -- node[right] {2} (3);   % edge 3
            \draw[gray, very thick] (4) -- node[below left] {1} (5);
            \draw[gray, very thick] (4) -- node[below right] {1} (3);
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \end{tikzpicture}}
        \captionof*{figure}{Backup-ready cycle: edges 4, 5, 6\\Choosing any two of them satisfies the minimum-cost network, just like the previous figures.}
    \end{minipage}
\end{center}
