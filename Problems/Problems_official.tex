...
\begin{center}
    \begin{minipage}{0.48\textwidth}
        ...
        \begin{tikzpicture}
            ...
            % Backup-Ready Edges
            \draw[gray, very thick] (4) -- node[below left] {1} (5);
            \draw[gray, very thick] (5) -- node[above] {1} (3);
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \draw[very thick] (2) -- node[above] {1} (0);   % edge 2
            \draw[very thick] (2) -- node[right] {2} (3);   % edge 3
            \draw[dashed, gray, very thick] (3) -- node[below right] {1} (4);   % edge 4
            \draw[dashed, gray, very thick] (4) -- node[below left] {1} (5);   % edge 5
            \draw[dashed, gray, very thick] (3) -- node[above] {1} (5);    % edge 6
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \begin{tikzpicture}
            ...
            % Backup-Ready Edges
            \draw[dashed, very thick, gray] (4) -- node[below left] {1} (5);
            \draw[dashed, very thick, gray] (5) -- node[above] {1} (3);
            \draw[dashed, very thick, gray] (3) -- node[below right] {1} (4); % edge 4
        \end{tikzpicture}}
        \captionof*{figure}{Backup-ready cycle: edges 4, 5, 6\\Choosing any two of them satisfies the minimum-cost network.}
    \end{minipage}
\end{center}
...
\newpage
\vspace*{\fill}
{\centering \huge This is the end of the problem statement.\par}
\vspace{\fill}
\newpage
