...
\\\\
\noindent
The ICN Administration seeks to establish a \textbf{minimum-cost network} that connects all space stations while ensuring its reliability. i.e. The administration seeks to find \textbf{a set of channels} with the minimum maintenance cost that connect all space stations. However, given the harsh space environment and potential meteor strikes, they must further classify the communication channels into two types:
...
\end{itemize}
The visualizations of the channels and their costs which has a total maintenance cost of 7 units:
\begin{center}
    \begin{minipage}{0.48\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \draw[thick] (0) -- node[above] {1} (1);
            \draw[thick] (1) -- node[above right] {1} (2);
