...
\usepackage{lastpage}
\usepackage{textcomp}
\newfontfamily\linesans[Path=C:/Users/jacob/AppData/Local/Microsoft/Windows/Fonts/]{LINESeedSans_XBd}
...
%\begin{flushright}
%    PDAO 2025 is sponsored by \textbf{© LINE}
%\end{flushright}
...
%    PDAO 2025 is sponsored by \\ \textcopyright \space {\linesans LINE}
%\end{minipage}
%\end{center}
...
Line 1 contains two integers \( N \) and \( M \), denoting the number of space stations and communication channels:
    \[
    2 \leq N \leq 100, \quad N-1 \leq M \leq 10^5.
    \]
\noindent
