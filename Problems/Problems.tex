...
\subsection*{\fontsize{16}{12}Input}
Line 1 contains a single integer \(t\), denoting the number of test cases, and each case contains two lines.
\\\\
\noindent
First line of each case contains an integer \( n \), representing the number of potion bottles.
\\\\
\noindent
Second line of each case contains \( n \) integers $k_i$, denoting the magical essence in the \( i^{th} \) potion bottle.
\begin{itemize}
    \item \(1 \leq t \leq 50\)
    \item \(1 \leq n \leq 10^5\)
    \item \(1 \leq k_i \leq 10^4\) (where \(k_i\) is the magical essence in the \(i^{th}\) potion bottle)
\end{itemize}

\subsection*{\fontsize{16}{12}Output}
For each case, print "Yes" if \textbf{Merlin} can force a win; otherwise, print "No".
\newpage
\subsection*{\fontsize{16}{12}Example 1}
\begin{table}[h]
  \centering
...
\subsection*{\fontsize{16}{12}Explanation}
\subsubsection*{\fontsize{16}{12}Case 1:}
...
\subsubsection*{\fontsize{16}{12}Case 2:}
