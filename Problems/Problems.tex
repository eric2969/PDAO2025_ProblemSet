...
\\\\
\noindent
Now give you a table of later game, a situation only containing a black general, a
red general and several red chariots, cannons and horses, and \textbf{red player}(i.e., the one on the \textbf{bottom}) has made a \textbf{move}. Now it is now \textbf{black player's turn}.
\\\\
\noindent
Your job is to determine that whether \textbf{Red player} will capture \textbf{Black general} in \textbf{Red player's next turn} no matter what \textbf{Black player} does in their turn.
\subsection*{\fontsize{16}{12}Input}
...
\subsection*{\fontsize{16}{12}Output}
A single line of "Yes" or "No", indicating if \textbf{Red player} will capture the \textbf{Black general} after \textbf{Black player} make their move.
